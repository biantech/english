...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir",
        type=str,
        default="/Users/bianjq/github/english/kaoyanfw20",
        help="target directory to scan mp3, default: /Users/bianjq/github/english/kaoyanfw20"
    )
    parser.add_argument(
        "--out",
        type=str,
        default="mp3_duration_list.csv",
        help="output csv file path, default: mp3_duration_list.csv"
    )
